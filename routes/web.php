...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/simpan_detail_rm', [PurchaseController::class, 'simpan_detail_rm'])->name('simpan_detail_rm');
    ...
    Route::delete('/hapus_pr/{id}', [PurchaseController::class, 'hapus_pr'])->name('hapus_pr');
