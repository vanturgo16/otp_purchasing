...
function edit_pr(id) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      $('#form_pr').attr('action', '/update_pr/' + response.data.find.id)
      $('#id_pr').val(response.data.find.id)
      $('#type_product_pr').val(response.data.find[0].type_product)
      $('#description_pr').val(response.data.find[0].description)
      $('#qty_pr').val(response.data.find[0].qty)
      $('#unit_code_pr').val(response.data.find[0].unit_code)
      $('#required_date_pr').val(response.data.find[0].required_date)
      $('#cc_co_pr').val(response.data.find[0].cc_co)
      $('#remarks_po').val(response.data.find[0].remarks)
