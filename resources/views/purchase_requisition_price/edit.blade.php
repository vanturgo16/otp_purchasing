    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> Edit PR Price ({{ $data->type }})</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edit Purchase Requisition Price ({{ $data->type }})</h4>
            </div>
            <form method="POST" action="{{ route('pr.price.update', encrypt($data->id)) }}" class="form-material m-t-40 formLoad" enctype="multipart/form-data">
                @csrf
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            if (response.success) {
                                                ...
                                                $('input[name="note"]').html(response.data.note);
                                            } else {
        ...
        <div class="card">
            ...
            <div class="card-body p-4">
                <table class="table table-bordered dt-responsive w-100" style="font-size: small" id="tableItem">
                    <thead>
                        <tr>
                            <th class="align-middle text-center" @if($data->input_price == 'Y') rowspan="2" @endif style="background-color: #6C7AE0; color:#ffff; border-bottom: 4px solid #e2e2e2;">No.</th>
                            <th class="align-middle text-center" @if($data->input_price == 'Y') rowspan="2" @endif style="background-color: #6C7AE0; color:#ffff; border-bottom: 4px solid #e2e2e2; border-right: 3px solid #e2e2e2;">Product</th>
                            <th class="align-middle text-center" @if($data->input_price == 'Y') rowspan="2" @endif style="background-color: #6C7AE0; color:#ffff; border-bottom: 4px solid #e2e2e2;">Required Date</th>
                            <th class="align-middle text-center" @if($data->input_price == 'Y') rowspan="2" @endif style="background-color: #6C7AE0; color:#ffff; border-bottom: 4px solid #e2e2e2;">CC / CO</th>
                            <th class="align-middle text-center" @if($data->input_price == 'Y') rowspan="2" @endif style="background-color: #6C7AE0; color:#ffff; border-bottom: 4px solid #e2e2e2;">Qty</th>
                            @if($data->input_price == 'Y')
                            ...
                            @endif
                            <th class="align-middle text-center" @if($data->input_price == 'Y') rowspan="2"  @endif style="background-color: #6C7AE0; color:#ffff; border-bottom: 4px solid #e2e2e2;">Remarks</th>
                            <th class="align-middle text-center" @if($data->input_price == 'Y') rowspan="2"  @endif style="background-color: #6C7AE0; color:#ffff; border-bottom: 4px solid #e2e2e2; border-left: 3px solid #e2e2e2;">Aksi</th>
                        </tr>
                        @if($data->input_price == 'Y')
                            <tr>
