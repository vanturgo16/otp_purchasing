    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('pr.updateItem', encrypt($data->id)) }}" class="form-material m-t-40 formLoad" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="input_price" value="{{ $inputPrice }}" required>
                <div class="card-body p-4">
                    ...
                    <div class="row mb-4 field-wrapper required-field">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" name="qty" id="qty" value="{{ $data->qty }}" placeholder="Masukkan Qty.." required>
                        </div>
                    </div>
                    <div class="row mb-4 field-wrapper required-field">
